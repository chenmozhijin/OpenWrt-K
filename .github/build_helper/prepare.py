...
def prepare() -> None:
    ...
    for repo, branch in to_clone:
        path = os.path.join(paths.workdir, "repos", repo.split("/")[-2], repo.split("/")[-1], branch)
    ...
    filters = {"1628750870.txt": "https://adguardteam.github.io/AdGuardSDNSFilter/Filters/filter.txt",
               ...
               "1677875717.txt": "https://cdn.jsdelivr.net/gh/cjx82630/cjxlist@master/cjx-annoyance.txt",
               ...
               "1677875721.txt": "https://raw.githubusercontent.com/adbyby/xwhyc-rules/master/lazy.txt",
               "1677875722.txt": "https://raw.githubusercontent.com/adbyby/xwhyc-rules/master/v",
               ...
               "1677875733.txt": "https://cdn.jsdelivr.net/gh/hl2gu",
               "1677875734.txt": "https://cdn.jsdelivr.net/gh/hg1978/AdGuard-Home-Whitelist@master/whitelist.txt",
               "1677875735.txt": "https://cdn.jsdelivr.net/gh/mmotti/adguard-home-filters@master/whitelist.txt",
               "1677875737.txt": "https://cdn.jsdelivr.net/gh/liwenjie119/adg-rules@master/white.txt",
               "1677875739.txt": "https://cdn.jsdelivr.net/gh/JamesDamp/AdGuard-Home---Personal-Whitelist@master/AdGuardHome-Whitelist.txt",
    ...
    for cfg_name, openwrt in openwrts.items():
        ...
        if clash_arch:
            ...
            dl_tasks.append(dl2(f"https://raw.githubusercontent.com/vernesong/OpenClash/core/master/meta/clash-{clash_arch}.gz",
        ...
        if os.path.isfile(os.path.join(tmpdir.name, "clash_tun.gz")):
            with tarfile.open(os.path.join(tmpdir.name, "clash_tun.gz"), "r:gz") as tar:
